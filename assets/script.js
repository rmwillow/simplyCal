$(document).ready(function() {
    ...
    //.each is a call back & iterates over each textarea section
    ...
    // setting each items in the local storage with new labels to show in local storage output
    $("button").on("click", function() {
        localStorage.setItem("6 AM Task", (timeSlot6.val()))
        localStorage.setItem("7 AM Task", (timeSlot7.val()))
        localStorage.setItem("8 AM Task", (timeSlot8.val()))
